...
import kotlinx.android.synthetic.main.activity_add_product.pbUploadImage
...
class  ProductDetailActivity : AppCompatActivity(), ProductDetailView {
   ...
   // private lateinit var product: Product
    ...
    override fun onProductDetailSuccess(apiResponse: ProductDetailResponse) {
        ...
        Glide.with(this).load(apiResponse.arrImageUrl.get(0)).into(ivMainDetail)
        Glide.with(this).load(apiResponse.arrImageUrl.get(0).toString()).into(ivThumb1Detail)
