...
class FilterCategoryMaterialAdapter(var mContext: Context, data: ArrayList<String>,
                                    var dtInterface: DataMaterialTransferInterface,
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        holder.checkBox!!.setOnCheckedChangeListener { buttonView, isChecked ->
            if (isChecked.also { mItemChecked[position] = it }) {
                ...
                dtInterface.setMaterialValues(filteredCategory)
...
//        }
    ...
    interface DataMaterialTransferInterface {
        fun setMaterialValues(materialList: ArrayList<String>)
    }
}