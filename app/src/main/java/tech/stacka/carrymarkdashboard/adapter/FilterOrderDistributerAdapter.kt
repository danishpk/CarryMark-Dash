...
class FilterOrderDistributerAdapter(var mContext: Context, data: ArrayList<String>, dataIds:ArrayList<String>,
                                    dtInterface:DataTransferInterface,
                                    var selctedDistIds: ArrayList<String>
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        for(i in selctedDistIds.indices){
            if(dataIds[position]==selctedDistIds[i])
                mItemChecked[position] = true
            Log.e("dataPosition",data[position])
            Log.e("filteredPosition",selctedDistIds[i])
        }
        ...
        holder.checkBox!!.setOnCheckedChangeListener { buttonView, isChecked ->
            if (isChecked.also { mItemChecked[position] = it }) {
                selctedDistIds.add(dataIds[position].toString())
                dtInterface.setDistValue(selctedDistIds)

            } else {
                selctedDistIds.remove(dataIds[position].toString())
                dtInterface.setDistValue(selctedDistIds)
            }
        }
        return convertView
    ...
    init {
        ...
        this.data = data
        this.selctedDistIds=selctedDistIds
...
//        }
    ...
    interface DataTransferInterface {
        fun setDistValue(arrSelectedDistributorIds: ArrayList<String>)
    }
}